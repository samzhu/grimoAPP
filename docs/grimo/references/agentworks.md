...
2. The main SDD phases are workflow steps: Discuss, Explore, Prototype, Spec, Usage, Tkt, Dev, Review and Wrap.
3. Each main step runs an automatic Quality Loop subworkflow: Review -> Rating -> Fix until the step passes its quality threshold.
